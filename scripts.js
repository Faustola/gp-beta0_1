...
botaoHamburgao.addEventListener('click', function() {
    if (i == 0) {
        ...
        iconeColchao.style.cssText="opacity: 1; top: 70px";
        iconeCadeira.style.cssText="opacity: 1; top: 100px";
        iconeTapete.style.cssText="opacity: 1; top: 130px";
        iconeGota.style.cssText="opacity: 1; top: 160px";
        i = 1;
        }else {
            botaoHamburgao.classList.add('anim-botao-menu');
        function removeAnimation() {
